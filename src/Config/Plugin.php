...
use F4fShopIntegration\Common\Traits\Singleton;
...
final class Plugin {
	...
	public function data(): array {
		$plugin_data = apply_filters( 'f4f_shop_integration_plugin_data', [
			'settings'               => get_option( 'f4f-shop-integration-settings' ),
			'plugin_path'            => untrailingslashit(
				plugin_dir_path( F4F_SHOP_INTEGRATION_PLUGIN_FILE )  // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
			),
			'plugin_template_folder' => 'templates',
			'ext_template_folder'    => 'f4f-shop-integration-templates',
			/**
			 * Add extra data here
			 */
		] );
		return array_merge(
			apply_filters( 'f4f_shop_integration_plugin_meta_data',
				get_file_data( F4F_SHOP_INTEGRATION_PLUGIN_FILE, // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
					[
						'name'         => 'Plugin Name',
						'uri'          => 'Plugin URI',
