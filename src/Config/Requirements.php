...
final class Requirements extends Base {
	...
	public function specifications(): array {
		return apply_filters( 'f4f_shop_integration_plugin_requirements', [
		...
		foreach (
			[
				...
				[
					...
					'title'   => __( 'Invalid PHP version', 'f4f-shop-integration' ),
					'message' => sprintf( /* translators: %1$1s: required php version, %2$2s: current php version */
						__( 'You must be using PHP %1$1s or greater. You are currently using PHP %2$2s.', 'f4f-shop-integration' ),
				...
				[
					...
					'title'   => __( 'Invalid WordPress version', 'f4f-shop-integration' ),
					'message' => sprintf( /* translators: %1$1s: required wordpress version, %2$2s: current wordpress version */
						__( 'You must be using WordPress %1$1s or greater. You are currently using WordPress %2$2s.', 'f4f-shop-integration' ),
